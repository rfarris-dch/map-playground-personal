...
import type { CountyScoreRow, CountyScoresStatusRow } from "./county-intelligence.repo.types";

export type { CountyScoreRow, CountyScoresStatusRow } from "./county-intelligence.repo.types";
