...
export function useAppShell() {
  ...
  useAppShellUrlState({
    ...
    setCountyPowerStoryThreeDimensionalEnabled:
      visibility.setCountyPowerStoryThreeDimensionalEnabled,
    setCountyPowerStoryVisible: visibility.setCountyPowerStoryVisible,
  ...
  return {
    ...
    countyPowerStoryDetailRow: selection.countyPowerStoryDetailRow,
    countyPowerStoryDetailLoading: selection.countyPowerStoryDetailLoading,
    countyPowerStoryDetailError: selection.countyPowerStoryDetailError,
    ...
    setParcelsVisible: visibility.setParcelsVisible,
    setGasPipelineVisible: visibility.setGasPipelineVisible,
    setCountyPowerStoryAnimationEnabled: visibility.setCountyPowerStoryAnimationEnabled,
    setCountyPowerStoryChapterId: visibility.setCountyPowerStoryChapterId,
    setCountyPowerStoryChapterVisible: visibility.setCountyPowerStoryChapterVisible,
    setCountyPowerStorySeamHazeEnabled: visibility.setCountyPowerStorySeamHazeEnabled,
    setCountyPowerStoryStoryId: visibility.setCountyPowerStoryStoryId,
    setCountyPowerStoryThreeDimensionalEnabled:
      visibility.setCountyPowerStoryThreeDimensionalEnabled,
    setCountyPowerStoryVisible: visibility.setCountyPowerStoryVisible,
    setCountyPowerStoryWindow: visibility.setCountyPowerStoryWindow,
    setPowerLayerVisible: visibility.setPowerLayerVisible,
