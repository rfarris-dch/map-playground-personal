...
import type { MapBounds, MapOverlaysQueryState } from "@/features/app/map-overlays.types";
import type {
  BuildFacilityAnchorParcelRequestsArgs,
  FacilityAnchorCandidate,
} from "./map-overlays.service.types";
...
export function buildMapOverlaysFetchKey(bounds: MapBounds): string {
