/**
 * County intelligence core score and status contracts.
 *
 * Debug, coverage, and resolution shapes have been moved to
 * county-intelligence-debug-http.ts.
 */
import { z } from "zod";
...
export const CountyScoresRequestSchema = z.object({
  countyIds: z.preprocess(parseCommaSeparated, z.array(CountyFipsSchema).min(1).max(500)),
});
