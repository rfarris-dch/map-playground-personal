...
**If the user already specified a clear comparison target** (e.g., "review against main", "compare with develop", "review last 3 commits"), **skip confirmation and proceed directly to Step 3** using the scope they specified.
...
**If you need to ask, STOP and wait for user confirmation before proceeding to Step 3.**
