...
function PageLink({
  ...
  return (
    <div {...props}>
      <dt className="font-display font-medium text-slate-900 text-sm dark:text-white">
        {dir === "next" ? "Next" : "Previous"}
      </dt>
      <dd className="mt-1">
        <Link
          className={clsx(
            "flex items-center gap-x-1 font-semibold text-base text-slate-500 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300",
...
export function PrevNextLinks() {
  ...
  return (
    <dl className="mt-12 flex border-slate-200 border-t pt-6 dark:border-slate-800">
