        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl text-transparent tracking-tight">
                Never miss the cache again.
              </p>
              <p className="mt-3 text-2xl text-slate-400 tracking-tight">
          ...
          <div className="relative lg:static xl:pl-10">
            <div className="mask-[linear-gradient(transparent,white,white)] lg:mask-none dark:mask-[linear-gradient(transparent,white,transparent)] lg:dark:mask-[linear-gradient(white,white,transparent)] absolute inset-x-[-50vw] -top-32 -bottom-48 lg:-top-32 lg:right-0 lg:-bottom-32 lg:left-[calc(50%+14rem)]">
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur-sm">
                ...
                <div className="pt-4 pl-4">
                  ...
                  <div className="mt-6 flex items-start px-1 text-sm">
                    <div
                      aria-hidden="true"
                      className="select-none border-slate-300/5 border-r pr-4 font-mono text-slate-600"
                    >
                      {Array.from({
                        length: code.split("\n").length,
                      }).map((_, index) => (
